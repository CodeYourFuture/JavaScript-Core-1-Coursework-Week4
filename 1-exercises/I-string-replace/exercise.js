...
let result= story.replace(/dogs/gi, "cats");
story= story.replace(/day/gi, "night");
story= story.replace(/10/gi,"100000");
story = story.replace(/dogs/gi,"cats");
story = story.replace(/great/gi,"brilliant");
story = story.replace(/day/gi,"night");
