...
let pairsByIndex= pairByIndexRaw.filter((name, index, array) => indexRaw && indexRaw.length===(name, index, array))
// or let pairsByIndex = pairsByIndexRaw.filter(indexRaw => indexRaw && indexRaw.length === 2);
