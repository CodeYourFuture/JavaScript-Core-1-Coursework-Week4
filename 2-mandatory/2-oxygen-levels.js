...
function findSafeOxygenLevel(arr) {
  return arr.find(forFind); //finds first value in array for which forFind(value) = true; argument of "find" should be function that returns true or false;
