...
function validatePasswords(passwords) {
  let validPasswords = passwords.containsUppercaseLetter() && passwords.containsLowercaseLetter();
  if (validPasswords.contains(Symbol) && validPasswords.contains(number)){
    return true;
  }else {
    return false;
  }
