...
function validatePasswords(passwords) {
  ...
  let result = passwords.map((password)=>{
    
    if(password.length >= 5 && containsUppercaseLetter(password) 
    && containsLowercaseLetter(password) && containsNumber(password) &&
    containsSymbol(password) && !previousPasswords.includes(password) ) {
