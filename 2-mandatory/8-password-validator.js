...
function validatePasswords(passwords) {
  return passwords.map((element, i, arr) => element.length >= 5 
  && containsLowercaseLetter(element) && containsNumber(element) && 
  containsUppercaseLetter(element) && containsSymbol(element) 
