...
function validatePasswords(passwords) {
  ...
  let booleanArr = passwords.map(function (password) {
    if (password.length >= 5 && containsUppercaseLetter(password) && containsLowercaseLetter(password) && containsNumber(password) && containsSymbol(password)) {
      return true;
