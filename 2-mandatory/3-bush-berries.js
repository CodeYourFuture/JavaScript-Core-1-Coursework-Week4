...
function isBushSafe(berryArray) {
  const approval = "Bush is safe to eat from";
  const warning = "Toxic! Leave bush alone!";

  const consumable = berryArray.every(function (berry) {
    return berry === "pink";
  });
  return consumable ? approval : warning;
}
