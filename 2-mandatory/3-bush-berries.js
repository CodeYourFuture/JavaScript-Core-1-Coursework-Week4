...
function isBushSafe(berryArray) {
  let itIsSafe = "Bush is safe to eat from"; 
  let itIsNotSafe = "Toxic! Leave bush alone!"

  let isSafeToEat = berryArray.every(function (berry) {
    return berry ==='pink'; 
    
  });
  return isSafeToEat ? itIsSafe : itIsNotSafe; 
}
