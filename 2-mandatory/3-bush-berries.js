/*
  ...
  Use the tests to confirm which message to return  This exercise can be solved in a few different ways. One way might include the array methods
  .some() and .every().   
...
function isBushSafe(berryArray) {
  ...
  if (berryArray.every(berriesColor)) {
