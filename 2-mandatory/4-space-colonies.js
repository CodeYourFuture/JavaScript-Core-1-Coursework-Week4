/*
  ...
  Create a function that returns an inputArray of colonisers that will stay, according to the above rules.

  NOTE: don't include any elementment that is not a "family".
...
function getSettlers(inputArray) {
  return inputArray.filter((element) => element.startsWith("A") && element.endsWith("family"));
}
