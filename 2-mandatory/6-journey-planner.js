...
function journeyPlanner(locations, transportMode) {
  let specificModeOfTransport =  locations.filter(arr => isAccessibleByTransportMode(arr, transportMode))
  specificModeOfTransport = specificModeOfTransport.map(arr => getLocationName(arr))
  return specificModeOfTransport;
 }
