...
*/
function isAccessibleByTransportMode(array, location) {
  return array.includes(location)
}
...
function journeyPlanner(locations, transportMode) {
  ...
  let eligibleLocations = locations.filter(location => location.includes(transportMode));
  return eligibleLocations.map(location => location[0]);
}
