...
*/
const getTransportModes = (locationWithTransportMode) =>
  locationWithTransportMode.slice(1);
...
*/
const isAccessibleByTransportMode = (arrayOfTransportMode, transportMode) =>
  arrayOfTransportMode.includes(transportMode);
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
const getLocationName = (locationWithTransportMode) =>
  locationWithTransportMode[0];
