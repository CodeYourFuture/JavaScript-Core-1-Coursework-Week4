...
*/
function isAccessibleByTransportMode(modes, str) {
  return modes.includes(str);
}
...
function journeyPlanner(locations, transportMode) {
  return locations.filter(locationName => locationName.includes(transportMode)).map(locationName => locationName[0]);
