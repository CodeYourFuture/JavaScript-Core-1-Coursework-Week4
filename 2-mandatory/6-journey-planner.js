...
*/
function getTransportModes(arrayOfLocationAndModes) {
  return arrayOfLocationAndModes.slice(1);
}
...
*/
function isAccessibleByTransportMode(arrayOfModes, strOfModes) {
    if (arrayOfModes.includes(strOfModes)){
      return true;
    }
}
