...
function checkCodeIsThere(stringText) {
  ...
  //edit code below
  if (stringText) {
  return stringText.includes(magicWord) ? stringText.indexOf(magicWord)
    : "Not found";
  } else {
    return "Not found";
  }
...
*/
function journeyPlanner(locations, transportMode) {  return locations.filter((x) => x.includes(transportMode)).map((b) => b[0]);
