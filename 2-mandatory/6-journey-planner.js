...
*/
function isAccessibleByTransportMode(transportPlace, transport) {
  return transportPlace.includes(transport);
}
...
function journeyPlanner(location, transport) {
  ...
  return location.filter(( location => location.includes(transport)))
}
