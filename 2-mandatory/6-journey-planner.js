...
*/
function getTransportModes(locationsAndAvailableTransports) {
  return locationsAndAvailableTransports.slice(1);
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(locationsAndAvailableTransports) {
  return locationsAndAvailableTransports[0];
}
...
*/
// function journeyPlanner(locationsAndAvailableTransports, getTransportModes) {
  
// }
 const journeyPlanner = (locations, transportMode) =>locations.filter((element) => element.includes(transportMode))
