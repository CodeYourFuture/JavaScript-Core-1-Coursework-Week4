...
*/
function isAccessibleByTransportMode(arrayTransportMode, transportMode) {
  return arrayTransportMode.includes(transportMode);
}
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(arrayTransportMode) {
  return arrayTransportMode[0];
}
...
function journeyPlanner(locations, transportMode) {
  ...
  for (lists of locations) {
    if (lists.includes(transportMode) === true) {
      allowedLocations.push(lists[0]);
    }
  }
