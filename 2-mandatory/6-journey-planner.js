...
/*
  ...
  To take you to Tower Bridge, you can use tube or river boat. This information will represented as
...
function getTransportModes(attractionTransport) {
  return attractionTransport.slice(1);
}
...
*/
function isAccessibleByTransportMode(transportModes, checkMode) {
  return transportModes.includes(checkMode);
}
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(locationTransportModes) {
  return locationTransportModes[0];
}
...
function journeyPlanner(locations, transportMode) {
  ...
  for (let location of locations) {
    if (
      isAccessibleByTransportMode(getTransportModes(location), transportMode)
    ) {
      validLocations.push(getLocationName(location));
    }
  }
