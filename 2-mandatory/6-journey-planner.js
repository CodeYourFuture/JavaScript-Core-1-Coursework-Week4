...
*/
function isAccessibleByTransportMode(arrayOfTransports,transportString) {
  return arrayOfTransports.includes(transportString);
}
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(array) {return array[0];}
...
function journeyPlanner(locations, transportMode) {
  ...
  for(i=0;i<locations.length;i++){
      if(isAccessibleByTransportMode(getTransportModes(locations[i]),transportMode)){
        possibleLocations.push(getLocationName(locations[i]));
      }
  }
