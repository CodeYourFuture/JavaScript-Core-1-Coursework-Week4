...
*/
function journeyPlanner(locationsAndTransportMode, transportMode) {
  let possibleLocationsAndTheirMode, possibleLocations = [];
  possibleLocationsAndTheirMode = locationsAndTransportMode.filter((item) => item.includes(transportMode));
  possibleLocations = possibleLocationsAndTheirMode.map((item) => item[0]);
