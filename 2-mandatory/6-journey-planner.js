...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(locTransportArr) {
  return locTransportArr[0];
}
...
function journeyPlanner(locations, transportMode) {
  ...
  function isValid(locTransportArr) {
    return locTransportArr.includes(transportMode);
  }

  let validArr = locations.filter(isValid);
