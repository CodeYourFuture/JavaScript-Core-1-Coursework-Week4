...
function journeyPlanner(locations, transportMode) {
  return locations.filter((locationAndTransport) =>
      isAccessibleByTransportMode(
        getTransportModes(locationAndTransport),
        transportMode)).map((locationAndTransport) => getLocationName(locationAndTransport));
}
