...
function getTransportModes(locationDetails) {
  return locationDetails.slice(1);
}
/*
...
function journeyPlanner(locations, transportMode) {
  return locations.filter((locationInfo) => isAccessibleByTransportMode(locationInfo, transportMode)).map((accessibleLocation) => getLocationName(accessibleLocation));
}
