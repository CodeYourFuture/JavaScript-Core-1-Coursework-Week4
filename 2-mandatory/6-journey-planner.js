...
*/
function getTransportModes(famouslocation) {
  const addressFamousLocation = famouslocation.splice(1, famouslocation.length);
  return addressFamousLocation;
}
...
*/
function isAccessibleByTransportMode(wholeaddresses, desireaddress ) {
  let result = wholeaddresses.includes(desireaddress) ? true : false;
  return result; 
}
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(famouslocation) {
  let famousLocationName = famouslocation[0];
  return famousLocationName;
}
