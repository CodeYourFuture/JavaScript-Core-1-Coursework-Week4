...
*/
function getTransportModes(tarnAndLoc) {
let transMode = tarnAndLoc.slice(1);
return transMode;
}
/*
...
*/
function isAccessibleByTransportMode(transport, transMode) {

  return transport.includes(transMode);
}
/*
...
function journeyPlanner(locations, transportMode) {
 ...
 let  accessibleLocations = locations.filter(location => location.includes(transportMode)).map(getLocationName);
