...
*/
function tidyUpString(arrayOfString) {
  return arrayOfString.map((string) => string.trim().replace("/", "").toLowerCase());
}
/*
Write a function that:
...
let copyArray = array.slice(); //for making copy of an array
