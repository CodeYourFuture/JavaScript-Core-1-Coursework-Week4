...
*/
function first5(arrayFirstFive) {
  return arrayFirstFive.slice(0, 5);
}
...
*/
function tidyUpString(cleanArray) {
  return cleanArray.map((array) => {
    return array.replace("/", "").trim().toLowerCase();
  });
}
