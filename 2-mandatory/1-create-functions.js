...
*/
const tidyUpString = (array) => array.map((b) => b.trim().replace(/\//g, "").toLowerCase());
...
const remove = (array, i) => array.slice(0, i).concat(array.slice(i + 1));
...
const formatPercentage = (array) => array.map((e) => (e >= 100 ? "100%" : `${Math.round(e * 100) / 100}%`));
