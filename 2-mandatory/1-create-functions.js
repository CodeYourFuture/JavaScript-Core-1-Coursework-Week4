...
*/
const first5 = (inputArray) => inputArray.slice(0, 5)
...
*/
const sortArray = (inputArray) => [...inputArray].sort()
/*
...
const tidyUpString = (inputArray) =>
  inputArray.map((arr) => arr.trim().replace(/\//g, '').toLowerCase())
...
/* const remove = (inputArray, n) => {
  let result = inputArray.splice(n, 1)
  return inputArray
}
 */
const remove = (inputArray, n) =>
...
const formatPercentage = (inputArray) =>
  inputArray.map((arr) => Math.round((arr > 100 ? 100 : arr) * 100) / 100 + '%')

// const srt = sortArray(['a', 'n', 'c', 'e', 'z', 'f'])
// console.log(srt === srt.slice())
// console.log(srt)
// console.log(srt.slice())
/* ======= TESTS - DO NOT MODIFY ===== */
