...
//   let removedSpaces = inputArray.replace(/^\s+|\s+$/gm,'');
//   return removedSpaces;
// }

function tidyUpString(inputArray) {
  let removedSpaces = inputArray.map(transformString);
  return removedSpaces;
}
...
function formatPercentage(inputNumbers) {
